...
//a23be1e18aa0109eb7311226bd4946f6faa6c839c76603db73e4a93bf9bc7fc8fdc713
        String address = Functions.generateAddress(RemmeFamilyName.PUBLIC_KEY.getName(), remmeAccount.getPublicKeyHex());
        boolean keyIsValid = publicKeyStorage.check(address).get();
        System.out.println(keyIsValid); // true
        PublicKeyInfo publicKeyInfo = publicKeyStorage.getInfo(address).get();
